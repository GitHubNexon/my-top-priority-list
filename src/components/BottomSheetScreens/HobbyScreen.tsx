...
const hobbyTypeList = [
    { label: 'Watchlist', value: 'Watchlist', icon: 'watchlist' },
    { label: 'Books', value: 'Books', icon: 'books' },
    { label: 'Music', value: 'Music', icon: 'music' },
    { label: 'Learning', value: 'Learning', icon: 'learning' },
    { label: 'DIY', value: 'DIY', icon: 'diy' },
    { label: 'E-Games', value: 'E-Games', icon: 'e-games' },
    { label: 'Toys', value: 'Toys', icon: 'toys' },
    { label: 'Photography', value: 'Photography', icon: 'photography' },
    { label: 'Sports', value: 'Sports', icon: 'sports' },
    { label: 'Other', value: 'Other', icon: 'other' },
];

type HobbyScreenProps = BottomSheetScreenProps & {
    notesProp?: Notes;
};

const HobbyScreen = ({ bottomSheetRef, notesProp }: HobbyScreenProps) => {
    ...
    const [hobbyTypeValue, setHobbyTypeValue] = useState<string | null>(
    ...
    useEffect(() => {
        ...
        const updateStates = () => {
            ...
            if (notesProp.TypeOfNotesCategory?.type) setHobbyTypeValue(notesProp.TypeOfNotesCategory.type);
    ...
    const handleSubmit = () => {
        const selectedHobbyType = hobbyTypeList.find(item => item.value === hobbyTypeValue);
        const selectedNoteType = noteTypeValue;

        if (!selectedHobbyType || !selectedNoteType) {
        ...
        const noteData: Notes = {
            ...
            Title: noteTitle,
            TypeOfNotesCategory: {
                type: selectedHobbyType.value,
                icon: selectedHobbyType.icon,
            },
            TypeOfNote: {
